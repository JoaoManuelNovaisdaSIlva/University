...
public class MainWindowController {
    ...
    @FXML
    protected void onFahrnheitAction(ActionEvent actionEvent){converterModel.updateForFahrnheit();}
    @FXML
    protected void onKelvinAction(MouseEvent me){converterModel.updateForKelvin();}
